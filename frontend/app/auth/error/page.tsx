...
import { ShieldAlert, Home, ArrowLeft, AlertTriangle, UserX, Lock } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    switch (error) {
      ...
      case 'OAuthSignInError':
        setErrorInfo({
          title: 'Sign In Error',
          message: 'There was a problem with your authentication provider. Please try again.',
