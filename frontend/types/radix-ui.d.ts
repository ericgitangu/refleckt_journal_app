...
declare module '@radix-ui/react-dropdown-menu' {
  ...
  // Root and Trigger
  export const Root: React.FC<RadixUIProps & { modal?: boolean; open?: boolean; defaultOpen?: boolean; onOpenChange?: (open: boolean) => void }>;
  export const Trigger: React.ForwardRefExoticComponent<RadixUIProps & { asChild?: boolean } & React.RefAttributes<HTMLElement>>;
  ...
  export const Arrow: React.ForwardRefExoticComponent<RadixUIProps & React.RefAttributes<HTMLElement>>;
  ...
  export const RadioGroup: React.FC<RadixUIProps & { value?: string; onValueChange?: (value: string) => void }>;
  export const RadioItem: React.ForwardRefExoticComponent<DropdownMenuRadioItemProps & React.RefAttributes<HTMLDivElement>>;
  export const Sub: React.FC<RadixUIProps & { open?: boolean; defaultOpen?: boolean; onOpenChange?: (open: boolean) => void }>;
  ...
  export const ItemIndicator: React.ForwardRefExoticComponent<RadixUIProps & { asChild?: boolean; forceMount?: boolean } & React.RefAttributes<HTMLSpanElement>>;
}
