...
export async function GET() {
  ...
  const entries = [
    ...
    },
    {
      ...
      content: "Ran into Sam at the coffee shop today. We haven\'t spoken since college, but it felt like no time had passed. We talked for nearly two hours about our careers, relationships, and dreams we still haven\'t given up on. It made me realize how many connections I\'ve let slip away over the years. I want to be more intentional about reaching out to old friends. Maybe I\'ll make a list of people to contact this weekend.",
